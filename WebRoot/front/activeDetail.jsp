		...
		<div class="main mt">
			   ...
			   <div class="right2 fl">
					...
					<%
					 ...
					 %>
						<strong>您的位置：</strong><a href="showFrontServlet">首页</a>&nbsp;&gt;&nbsp;<a  href="frontActiveListServlet">专题活动</a>&nbsp;&gt;&nbsp;<%=vo.getActiveTitle() %>
					</div>
					<div class="article mt">
					  <h1 align="center"><%=vo.getActiveTitle() %></h1>
						<div class="info">时间：<%=vo.getActivePublishTime() %>    发布者：<%=vo.getActivePublisher() %></div>

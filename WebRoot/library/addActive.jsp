		...
		<!-- 
		 ...
		 -->
			...
			<div id="breadcrumb">
				...
				<a href="/Library/library/addActive.jsp" class="tip-bottom">添加</a>
					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<form id="active"  method="post" class="form-horizontal" action="/Library/servlet/addActiveServlet" />
								
									
									<div class="control-group">
										<label class="control-label">活动名称：</label>
										<div class="controls">
											<input name="activeTitle" id="activeTitle" style="width:300px" type="text" >
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">活动发布者：</label>
										<div class="controls">
											<input name="activePublisher" id="activePublisher" style="width:300px" type="text" >
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<textarea rows="20" cols="30" id="activeContent" name="activeContent"></textarea>
										</div>
									</div>

...
<!-- 富文本编辑器结束 -->
  ...
  <body >
   <jsp:include  page="left.jsp"/>
    ...
    <% 
    	ActiveVo activeVo=(ActiveVo)request.getAttribute("activeVo");
    
     %>
			<div id="breadcrumb">
				<a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
				<a href="#" class="tip-bottom">修改</a>
					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<form id="active" method="post" class="form-horizontal" action="/Library/servlet/updateActiveServlet" />
								
									
									<div class="control-group">
										<label class="control-label">活动名称：</label>
										<div class="controls">
											<input name="activeTitle" id="activeTitle" value="<%=activeVo.getActiveTitle() %>"  style="width:300px" type="text" >
											<input name="activeId" type="hidden" value="<%=activeVo.getActiveId() %>" /> 
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">活动发布者：</label>
										<div class="controls">
											<input name="activePublisher" id="activePublisher" value="<%=activeVo.getActivePublisher() %>" style="width:300px" type="text" >
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<textarea rows="20" cols="30" id="activeContent" name="activeContent"  ><%=activeVo.getActiveContent() %></textarea>
										</div>
									</div>

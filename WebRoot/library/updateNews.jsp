					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<form id="news"  method="post" class="form-horizontal" action="/Library/servlet/updateNewsServlet" />
								
									
									<div class="control-group">
										<label class="control-label">新闻名称：</label>
										<div class="controls">
											<input name="newsTitle" value="<%=newsVo.getNewsTitle() %>"  style="width:300px" type="text" >
											<input name="newsId" id="newsId" type="hidden" value="<%=newsVo.getNewsId() %>" /> 
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">新闻发布者：</label>
										<div class="controls">
											<input name="newsPublisher" id="newsPublisher" value="<%=newsVo.getNewsPublisher() %>" style="width:300px" type="text" >
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<textarea rows="20" cols="30" id="newsContent" name="newsContent"  ><%=newsVo.getNewsContent() %></textarea>
										</div>
									</div>

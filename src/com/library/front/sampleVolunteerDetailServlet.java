...
public class sampleVolunteerDetailServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public sampleVolunteerDetailServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/front/sampleVolunteerDetail.jsp").forward(request, response);
	}

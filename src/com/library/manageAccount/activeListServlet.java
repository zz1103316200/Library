...
public class activeListServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		List activeList=dao.selectByManageId(userVo.getAccountId()+"");
		request.setAttribute("activeList",activeList);
		
		request.getRequestDispatcher("/library/activeList.jsp").forward(request, response);
	}

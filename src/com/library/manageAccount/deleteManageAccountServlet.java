...
public class deleteManageAccountServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public deleteManageAccountServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		IDAO manageDao=new ManageAccountDao();
		
		manageDao.delete(new Object[]{accountId});

...
public class updateVolunteerActiveServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public updateVolunteerActiveServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		volunteerActiveDao.update(new Object[]{activeDate,activeContent,activeHours,confirmPeople,activeId,volunteerId,evaluation});

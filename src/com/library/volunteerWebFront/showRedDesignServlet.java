...
public class showRedDesignServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public showRedDesignServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/redDesign/index.jsp").forward(request, response);
